...
class Singlelinked(Generic[T]):
    ...
    def __add__(self, other: "Singlelinked[T]") -> "Singlelinked[T]":
        """*__add__()* función nativa de Python personalizada para el *Singlelinked*. Permite utilizar el operador de suma (+) de Python para concatenar dos estructuras de datos *Singlelinked*.
