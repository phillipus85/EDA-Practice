...
def remove_element(lt: dict, pos: int) -> Any:
    try:
        ...
        err("doublelink", "remove_element()", e)
...
def is_present(lt: dict, element: Any) -> int:
    try:
        ...
        err("doublelink", "is_present()", e)


def sub_list(lt: dict, start: int, end: int) -> dict:
    try:
        sub = new_double_lt(lt.get("cmp_function"), lt.get("key"))
        i = 0
        while i < lt.get("size"):
...
def iterator(lt: dict) -> object:
    try:
        ...
        err("doublelink", "iterator()", e)


def reverse(lt: dict) -> object:
    try:
        pass
    except Exception as e:
        err("doublelink", "reverse()", e)


def concat(lt1: dict, lt2: dict) -> dict:
    try:
        new_lt = new_double_lt(lt1.get("cmp_function"), lt1.get("key"))
        i = 0
